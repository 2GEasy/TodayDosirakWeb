...
export default function EngagementCard01 (props) {
    ...
    return (
      <Link to={{pathname:`/customer/menu/${props.su_id}/${props.mn_id}`,state: {name:props.name,produce:props.produce,price:props.price,img:path}}} style={{textDecoration:'none'}}>
