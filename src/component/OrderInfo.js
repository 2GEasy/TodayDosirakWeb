...
export default function OrderInfo(props) {
    ...
    return (
        ...
        <TableRow>
            ...
            <TableCell><DeliveryState ord={props.ord} su_id={props.su_id} pu_id={props.pu_id} stateRefresh={props.stateRefresh}/></TableCell>
            <TableCell><OrderCancel ord={props.ord} su_id={props.su_id} pu_id={props.pu_id} stateRefresh={props.stateRefresh} /></TableCell>
        </TableRow>
        </>
    );
}